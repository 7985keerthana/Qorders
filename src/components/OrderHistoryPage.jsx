...
export default function OrderHistoryPage({ onBack }) {
  ...
  return (
    <div className="relative w-full max-w-md bg-white min-h-screen sm:min-h-[750px] sm:h-[812px] sm:rounded-[36px] sm:shadow-2xl sm:border sm:border-gray-200 flex flex-col font-sans overflow-hidden">
      ...
      {/* Date Filter Badges */}
      <div className="px-5 py-2 flex justify-end gap-2.5">
        <div className="bg-[#F1F1F1] px-3.5 py-1.5 rounded-lg text-xs font-medium text-gray-700 flex items-center gap-1 cursor-pointer">
          <input
            type="date"
            value={startDate}
      ...
      {/* Orders List Content */}
      <div className="px-5 py-3 space-y-3.5 overflow-y-auto no-scrollbar flex-1 pb-8">
